...
var news1 = function news1(_ref) {
  ...
  // });
  Object(react__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(function () {// window.addEventListener('resize', updateImageWidths);
    // updateImageWidths();
  }, []);
  ...
  console.log(modText);
  modText = (Object(_babel_runtime_corejs2_helpers_esm_readOnlyError__WEBPACK_IMPORTED_MODULE_1__["default"])("modText"), html_react_parser__WEBPACK_IMPORTED_MODULE_3___default()(modText));
  console.log(modText);
  ...
  return __jsx("div", {
    ...
    __self: this
  }, "Details"), __jsx(_adv__WEBPACK_IMPORTED_MODULE_4__["default"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 80
    },
...
//# sourceMappingURL=3.f23c668afa90ede512bf.hot-update.js.map