...
var Adv = function Adv(context) {
  ...
  if (context.params) {
    ...
    var num = Math.floor(Math.random() * 4); //let bannerx = 'https://data.joornalo.com/ads/' + context.params.size + String(num) + '.jpg'
  }
  /*
...
//# sourceMappingURL=2.41739fa8e0a12db7b6cf.hot-update.js.map