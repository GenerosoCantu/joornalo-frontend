...
var Adv = function Adv(context) {
  ...
  if (context.params) {
    banner = context.params.size; //let num = Math.floor(Math.random() * 4)
    //let bannerx = 'https://data.joornalo.com/ads/' + context.params.size + String(num) + '.jpg'
  }
  /*
...
//# sourceMappingURL=1.7d0b52c08f483015d66f.hot-update.js.map