...
News.getInitialProps = function _callee(context) {
  var _context$query, section, date, id, uuid, titleUrl, url, path, res, data, templateUrl;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          path = 'https://data.joornalo.com/news/' + uuid.charAt(0) + '/' + uuid.charAt(1) + '/' + uuid + '.json';
          console.log(uuid);
          _context.prev = 6;
          _context.next = 9;
        ...
        case 16:
          // const templateUrl = 'https://data.joornalo.com/template/' + data['temaplate'];
          templateUrl = "https://data.joornalo.com/template/".concat(data['temaplate'], ".json");
...
//# sourceMappingURL=[id].js.8149d544368eab3ba5a5.hot-update.js.map