...
News.getInitialProps = function _callee(context) {
  var _context$query, section, date, id, uuid, url, path, userAgent, mobilex, android, iPad, mobile, tablet, desktop, res, data, templateUrl, res2, template;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          mobile = mobilex && !iPad;
          tablet = !mobilex && android || Boolean(iPad);
...
//# sourceMappingURL=[id].js.02aedc849e336d0ed9b8.hot-update.js.map