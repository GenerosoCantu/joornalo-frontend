...
var news1 = function news1(_ref) {
  ...
  for (var _i = find.length - 1; _i--;) {
    ...
    find[_i + 1] = '<img src="https://data.joornalo.com/news/4/c/' + data.images[imageNum - 1].url + ' />' + find[_i + 1].substring(3);
    console.log(find[_i + 1]);
...
//# sourceMappingURL=[id].js.e09028db6bcc82e25e9e.hot-update.js.map