    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          url = '/section/' + section + '/' + date + '/' + id; //const path = 'https://data.joornalo.com/news/' + uuid.charAt(0) + '/' + uuid.charAt(1) + '/' + uuid + '.json';
...
//# sourceMappingURL=[id].js.0c0755ede67edc7255e3.hot-update.js.map