...
var news1 = function news1(_ref) {
  ...
  tmp = (Object(_babel_runtime_corejs2_helpers_esm_readOnlyError__WEBPACK_IMPORTED_MODULE_1__["default"])("tmp"), find.join());
  find = (Object(_babel_runtime_corejs2_helpers_esm_readOnlyError__WEBPACK_IMPORTED_MODULE_1__["default"])("find"), tmp.split('<image id="'));
  ...
  for (var _i = find.length - 1; _i--;) {
    ...
    console.log('-------------------------------------2');
    console.log(data.media[imageNum - 1]);
...
//# sourceMappingURL=[id].js.584dfebd9ad7c2c0a940.hot-update.js.map