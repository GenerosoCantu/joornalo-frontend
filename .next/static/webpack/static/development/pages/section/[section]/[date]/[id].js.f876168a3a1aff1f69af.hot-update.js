...
var news1 = function news1(_ref) {
  ...
  for (var i = find.length - 1; i--;) {
    var mediaNum = _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_1___default()(find[i + 1].charAt(0));
  ...
  for (var _i = find.length - 1; _i--;) {
    var imageNum = _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_1___default()(find[_i + 1].charAt(0));

    find[_i + 1] = '<img src="https://data.joornalo.com/news/4/c/' + data.images[imageNum - 1].url + '" />' + find[_i + 1].substring(5);
  }

  var modText = html_react_parser__WEBPACK_IMPORTED_MODULE_4___default()(find.join());
  return __jsx("div", {
    className: "news",
    __source: {
...
news1.getInitialProps = function _callee(ctx) {
...
//# sourceMappingURL=[id].js.f876168a3a1aff1f69af.hot-update.js.map