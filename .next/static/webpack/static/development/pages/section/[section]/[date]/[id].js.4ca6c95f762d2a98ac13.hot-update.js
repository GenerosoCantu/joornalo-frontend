...
var news1 = function news1(_ref) {
  ...
  for (var i = find.length - 1; i--;) {
    ...
    console.log('-------------------------------------2');
    console.log(data.media[mediaNum]); //find[i + 1] = '<div className="embed">' + data.media[mediaNum].embed + '</div>' + find[i + 1].substring(5);
    //console.log(find[i + 1]);
...
//# sourceMappingURL=[id].js.4ca6c95f762d2a98ac13.hot-update.js.map